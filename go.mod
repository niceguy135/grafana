...
require (
	...
	google.golang.org/api v0.154.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20231120223509-83a465c0220f // indirect; @grafana/backend-platform
)
